...
let elementTraslate = document.querySelectorAll(
  "h1, h2, h3, h4,thead>tr>th, p, label, option, a, button"
);
...
const translateFunction = async (source, target, text) => {
  ...
  const options = {
    ...
    headers: {
      ...
      "X-RapidAPI-Key": "680ed4d775msh2823909cdea981dp195546jsnd03f067dc060",
